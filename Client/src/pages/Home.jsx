    ...
    <div className="m-3 2xl:m-6 space-y-4">
      ...
      {!isProfileComplete() && (
        ...
        >
          ...
          <Link
            to="/settings"
            className="inline-block px-5 py-2 rounded-xl font-semibold bg-gradient-to-r from-red-600 to-pink-600 text-white hover:from-red-500 hover:to-pink-500 transition shadow-[0_0_18px_rgba(255,0,0,0.8)]"
          >
            Complete Now
          </Link>
        </div>
